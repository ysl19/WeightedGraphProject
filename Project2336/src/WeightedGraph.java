...
public class WeightedGraph<V> extends AbstractGraph<V> {
	...
	/*constructing WeightedGraph from vertices and edged in arrays*/
	public WeightedGraph(V[] vertices, int[][] edges) {
		createWeightedGraph(java.util.Arrays.asList(vertices), edges);
	}
	
	/*constructing a WeightedGraph from vertices and edges in list*/
	...
	/*Weighted graph for vertices 0,1,2, and edge list */
	public WeightedGraph(List<V> vertices, List<WeightedEdge> edges) {
		createWeightedGraph(vertices, edges);
	}
	
	/*Weighted graph from vertices 0,1, and edge array */
	...
	/* create adj lists from edge arrays */
	...
	public MST getMinimumSpanningTree(int startingVertex) {
		...
		cost[startingVertex] = 0;				//cost of course is 0
		...
		while (T.size() < getSize()) {
			...
			//Adjust cost[v] for v that is adj to u and v in V - T
	...
	public ShortestPathTree getShortestPath(int sourceVertex) {
		...
		parent[sourceVertex] = -1; 		//parent of the course is set to -1
	...
	/** ShortestPath Tree is an inner class in WeightedGraph */
